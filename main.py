...
twilio_account_sid = "------enter_data_here-------"
twilio_auth_token = "------enter_data_here-------"
text_message = ""
STOCK = "TSLA"  # The stock we will need news for is tesla
API_KEY_STOCK = "------enter_data_here-------"  # API key for Alpha vantage
...
if percent_change >= 5 or percent_change <= -5:  # If there is a more than 5% swing in the stock price from yesterday compared to the day before, this "if" statement is triggeredd
    ...
    message = client.messages \
        ...
        from_='------enter_data_here-------',  # The host phone number from where it is sent
        to='------enter_data_here-------'  # The recipient phone number from where it will be sent
    )
